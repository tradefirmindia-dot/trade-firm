...
export default function FxLeadForm() {
    ...
    <form className={styles.leadForm} onSubmit={submit}>
      ...
      <div className={styles.formHeading}>
        <div>
          ...
          <h3>Request guided MT5 account setup.</h3>
      ...
      <label className={styles.consent}>
        ...
        <span>I agree to be contacted by TRADE FIRM through call, email or WhatsApp about account setup and research support.</span>
      </label>

      <button className={styles.submitButton} disabled={loading}>
        <span>{loading ? "Sending securely to CRM..." : "Request a desk callback"}</span>
        <ArrowRight size={18} />
      </button>
