...
import { brokerSeoPosts } from "./broker-seo-posts.js";
...
export const blogPosts = [
  ...
  },
  {
    ...
    excerpt: "Use this India-focused intraday advisory checklist to evaluate session context, actionable levels, NSE and BSE liquidity, position size and exit conditions.",
    readTime: "8 min read",
    updated: "2026-08-21",
    intro:
    ...
    sections: [
      ...
      {
        title: "Use the Indian market session as a decision clock",
        paragraphs: [
        ...
        bullets: ["Pre-market context", "Opening 15-minute range", "First-hour structure", "Scheduled event check", "Closing review"],
      },
      {
  ...
  },
  {
    ...
    excerpt: "Compare how intraday and swing research use different market context, levels, holding risk, monitoring routines and review timelines.",
    readTime: "5 min read",
    intro:
  ...
  },
  {
    ...
    excerpt: "Follow the evidence-to-risk process an Indian stock market research firm can use to frame scenarios, invalidation and decision risk.",
    readTime: "7 min read",
  ...
  },
  {
    ...
    excerpt: "Understand how time decay, option sensitivity, liquidity and position sizing can change as an Indian options contract approaches expiry.",
    readTime: "6 min read",
  ...
  },
  {
    ...
    excerpt: "Learn how to read open interest, volume, price and implied volatility as option-chain context without treating any one metric as a trading signal.",
    readTime: "7 min read",
  ...
  },
  {
    ...
    excerpt: "Separate India VIX from a contract’s implied volatility and understand how each measure informs options context, pricing and risk.",
    readTime: "6 min read",
  ...
  },
  {
    ...
    excerpt: "Understand the difference between thesis invalidation and a stop-loss order, then connect both to quantity and maximum rupee risk.",
    readTime: "5 min read",
  ...
  },
  {
    ...
    excerpt: "Turn capital, permitted loss, premium-to-stop distance and lot quantity into a practical pre-trade position-sizing check for options.",
    readTime: "6 min read",
  ...
  },
  {
    ...
    excerpt: "See how fundamental evidence and technical market structure answer different parts of an equity research and timing decision.",
    readTime: "6 min read",
