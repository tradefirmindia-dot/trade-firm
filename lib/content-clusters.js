export const contentClusters = [
  ...
  {
    slug: "dhan-demat-and-trading-account",
    name: "Dhan Demat & Trading Account",
    title: "Dhan Demat Account and Online Trading Guides",
    description: "Source-backed guides for opening and evaluating a Dhan Demat and trading account, including KYC, documents, pricing, referral attribution and account security.",
    keywords: ["Dhan Demat account", "Dhan account opening", "Dhan referral link", "online trading account India"],
    serviceHref: "/dhan-demat-account",
    toolHref: "/tools/risk-planner",
    intro: "A trading account should be understood before it is opened. This collection connects the Dhan registration route with KYC preparation, published pricing, referral disclosure, account security and first-order risk so users can evaluate the complete journey rather than only the account-opening button.",
    sections: [
      {
        title: "Map the complete account-opening journey",
        text: "Begin through the intended official route, verify contact details, complete the requested KYC and e-sign steps, then wait for account approval. Registration, activation and segment access are separate stages.",
        points: ["Official registration destination", "Mobile and email verification", "KYC and e-sign", "Account and segment approval"],
      },
      {
        title: "Prepare consistent KYC records",
        text: "PAN, identity, address, bank, photograph and signature information should be clear and consistent. Certain segments can require additional financial records, so the live platform checklist remains the final source.",
        points: ["Identity and PAN", "Address and contact", "Bank ownership", "Segment-specific records"],
      },
      {
        title: "Compare the full cost, not one headline",
        text: "Account opening and AMC are different from brokerage, statutory charges, DP charges, financing, square-off and assisted-order costs. Estimate the tariff for the intended strategy and verify it through current official pricing.",
      },
      {
        title: "Keep referral, custody and trading decisions separate",
        text: "A referral link identifies an onboarding route. Dhan remains responsible for brokerage, KYC, funds, holdings and execution. Credentials, OTPs and trading money should never be given to a referrer or research provider.",
      },
    ],
  },
  {
    slug: "forex-mt5-india",
    name: "Forex & MT5 for Indian Traders",
    title: "Forex Broker and MT5 Verification Guides for India",
    description: "A verification-first research library for Indian residents evaluating forex brokers, MT5 accounts, XAUUSD, UPI, bank transfers, withdrawals and leveraged-product risk.",
    keywords: ["forex broker India", "MT5 account India", "UPI forex deposit", "XAUUSD trading India"],
    serviceHref: "/forex-broker-india",
    toolHref: "/tools/risk-planner",
    intro: "Forex access for an Indian resident involves more than choosing an app. This collection separates RBI and authorisation checks, the broker's legal entity, MetaTrader 5 software, instrument specifications, funding and withdrawal operations, session behaviour and position risk into one reviewable process.",
    sections: [
      {
        title: "Verify authorisation before platform features",
        text: "Review current RBI guidance, authorised persons, authorised electronic trading platforms and the Alert List. A convenient app, payment method or absence from an alert list does not by itself establish authorisation.",
        points: ["RBI forex FAQ", "Authorised persons and ETPs", "Current Alert List", "Specific product and purpose"],
      },
      {
        title: "Separate MT5 software from the broker",
        text: "MetaTrader 5 provides charts, analysis and order interfaces. The broker provides the account, symbols, server, prices, contract terms, execution and financial relationship. Each layer requires its own checks.",
      },
      {
        title: "Review specifications before quantity",
        text: "Contract size, tick value, margin, leverage, spread, commission, swap, volume step and trading hours determine actual product risk. A familiar symbol name does not create a standard contract.",
        points: ["Contract and tick value", "Margin and leverage", "Spread and financing", "Session and order rules"],
      },
      {
        title: "Treat deposits and withdrawals as one journey",
        text: "Check beneficiary identity, payment currency, conversion, fees, limits, processing times and the documented withdrawal path before funding. Use only instructions displayed inside the user's own verified account.",
      },
    ],
  },
];
...
export function getPostClusterSlug(post) {
  ...
  if (/dhan|demat account|brokerage charges|referral link/.test(text)) return "dhan-demat-and-trading-account";
  if (/forex|mt5|xauusd|currency pair/.test(text)) return "forex-mt5-india";
